...
public class ConfigurationServiceAreaWarehouse extends ModelConfigurationGeneric{
	...
	public String getWarehouseEntityId()
	{
		return (String) super.getProperty2();
	}

	public void setWarehouseEntityId(String newWarehouseEntityId)
	{
		super.setProperty2(newWarehouseEntityId);
		return;
	}
